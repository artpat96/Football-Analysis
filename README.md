...
- wczytywanie i odpowiednia implementacja danych
- manipulacja danymi z pomocą biblioteki Pandas (grupowanie danych, wyciąganie średnich, maksymalnych oraz minimalnych wyników z danych kolumn, wyciąganie z tabeli konkretnych, interesujących nas danych)
...
- wyciąganie wniosków z tworzonej analizy (plik .txt załączony w repozytorium)
...
- loading and appropriate implementation of data
